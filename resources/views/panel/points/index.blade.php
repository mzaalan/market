            ...
            <div class="panel-body">
              <div class="panel-body-img red-border ">
                ...
                <div class="col-md-12 gall-edit hide">
                  <button  class="btn btn-default btn-table remove-img" data-href="{{ action('PointsMagazineController@destroy', 1)}}" class="text-danger" data-toggle="modal" data-target="#delete-confirmation-modal"  > 
      ...
      <div class="col-md-12 no-right-padding admin-gall-box" >
        <div >
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <form method="POST" action="{{action('PointsMagazineController@store') }}" class="dropzone dash-border" enctype="multipart/form-data" id='real-dropzone'>    
               {!! csrf_field() !!}
               <div class="fallback">
              ...
              <div class="dz-default dz-message new-div">
                <div class="plus">
                  ...
                  <input type="hidden" name="type" value="PointsMagazine">
                </div>
              </div>
            </form>
          ...
          <div class="panel-body">
            ...
            <div class="panel-body-img red-border ">
              ...
              <div class="col-md-12 gall-edit">
                <button class="btn btn-default btn-table" data-href="{{ action('PointsMagazineController@destroy', $post->id)}}" class="text-danger" data-toggle="modal" data-target="#delete-confirmation-modal"  > 
                  <i class="fa fa-times "> </i>   </button>
